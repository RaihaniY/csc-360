...
const Product = class Product {
    ...
    constructor(input){
        ...
        this.price = parseFloat(splittedInput[1]);
        this.availability = splittedInput[2];
    }
    ...
    static printProducts = (products) => {
        products.forEach(product => {
            var stock = product.availability == "In Stock" ? "Yes" : "No";
            var price = new Intl.NumberFormat("en-US", {style: 'currency', currency: 'USD'}).format(product.price)
            console.log("Product: " + product.name + ", Cost: " + price + ", Availability: " + stock)
        });
    }
